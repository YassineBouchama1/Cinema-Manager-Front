        ...
        <div className="bg-gray-800 p-4 rounded-lg w-full">
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='perspective-800 w-full flex justify-center mb-10'>
                    <div className="bg-white h-28 w-[80%] my-4 transform -rotate-x-45 shadow-lg shadow-white flex justify-center items-center">
                        <p className='text-gray-900'>Screen</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid gap-2 w-full" style={{ gridTemplateColumns: `repeat(${seatsPerRow}, minmax(0, 1fr))` }}>
                {Array.from({ length: roomCapacity }, (_, index) => (
                    <button
                        key={index + 1}
                        className={`w-6 h-6 rounded-t-2xl ${reservedSeats.includes(index + 1)
