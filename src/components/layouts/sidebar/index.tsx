...
import { useState } from 'react';  // Import useState to handle sidebar visibility
    ...
    return (
        <>
            ...
            <div className={`bg-white dark:bg-gray-900 text-gray-800 dark:text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 transition-transform duration-200 ease-in-out z-40`}>
                ...
                <nav>
                    <Link href="/admin" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 dark:hover:bg-gray-700">
                        <Home className="inline-block mr-2" size={20} />
                        Home
                    </Link>
                    <Link href="/admin/movies" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-200 dark:hover:bg-gray-700">
