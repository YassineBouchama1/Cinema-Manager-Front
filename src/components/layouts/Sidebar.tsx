...
'use client'
import { Home, Users, Compass, Calendar, User, UserPlus, Film, Settings, LogOut } from 'lucide-react';
...
const Sidebar: React.FC = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
